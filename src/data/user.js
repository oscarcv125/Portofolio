const INFO = {
	...
	projects: [{
		...
		{
			id: "ringbuilder",
			mainLogo: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/threejs/threejs-original.svg",
			title: "Lumière 3D Ring Builder",
			description:
				"Interactive 3D customizer for high-end jewelry. Built with React Three Fiber and Three.js, it allows users to dynamically build engagement rings by toggling features like Halos and Pavé bands, seamlessly loading optimized GLB models in real-time.",
			logos: ["https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/react/react-original.svg", "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/threejs/threejs-original.svg", "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/typescript/typescript-original.svg", "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/vite/vite-original.svg"],
			linkText: "View Project",
			link: "/project/ringbuilder",
			tags: ["web"],
		}
	],
};
